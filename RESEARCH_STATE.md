...
Under RH, prove a genuine zeta-zero normalized gap result below 1/2, preferably with positive density under a clearly specified AH formulation, or a concrete out-of-band pair-correlation result. Arithmetic residual Gram/new accessible support is the main lane. RMT collision results are supporting probability results, not substitutes for this target.
...
- Astra: main proof dependency decisions and integration. Round 5 is archived; the next prime-sieve decision is a justified larger profile/support change or a rigorous bound on the current finite family. The arithmetic residual-Gram/zeta target remains the main programme.
- Internal research agents: the three bounded radius/plateau, source-admissibility and exceptional-square assignments are complete. Their proofs, failed trials and rechecks are preserved. No automatic larger parameter sweep is running from those assignments.
