...
def face_matrix(trial, descriptors):
    ...
    mass,lam,pair=trial.dtype(".99998"),trial.dtype(".008"),trial.dtype(".34")
...
def main():
    ...
    trial=Trial(args.k,args.intervals,args.tilt)
    ...
    for cutoff in (1e-8,1e-10,1e-12):
        ...
        if args.validate:
            independent=Trial(args.k,args.intervals,args.tilt)
    ...
    prefix=HERE/f"ritz_k{args.k}_n{args.intervals}"
