...
const text = fs.readFileSync(path.join(__dirname, 'FOLLOWUP_TRANSPOSE_PAIRING.md'), 'utf8');
...
fs.writeFileSync(path.join(__dirname, 'transpose_math_syntax_check.json'), JSON.stringify(result, null, 2) + '\n');
