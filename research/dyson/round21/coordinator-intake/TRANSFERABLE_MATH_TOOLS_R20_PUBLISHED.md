...
**最新检查点：2026-09-05，协调任务已完成第十八至二十轮所提交证明的普通审查；这几轮不等同于外部审稿或 Lean 验证。** 当前已核实的最新公开版本为[第二十轮提交 `037ba82d9c3f2918b7e23a7598cee5dc996546ee`](https://github.com/QingyunSun/Riemann-hypothesis-and-random-matrix/blob/037ba82d9c3f2918b7e23a7598cee5dc996546ee/research/reports/dyson_round20.md)。公开报告已全文核对；三份作者稿件与已审查的 SHA-256 一致；64 份公开原始文件已独立下载并与本地归档逐字节比较，包含全部 49,152 行计算分段。原始材料提取已经交付；后续实例来自本项目推导。当前最明确的目标是在 RH 下证明一个实际的正平均素数方差严格低于 AH 的饱和值。该严格不等式与原 Bragg 缺口有正上极限等价，但两者均尚未证明。
