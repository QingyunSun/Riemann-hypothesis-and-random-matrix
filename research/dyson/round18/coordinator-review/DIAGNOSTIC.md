...
Date: 2026-09-05. Reviewer: Aquinas. This calculation was derived independently before reading the R18 author formula. It is an ordinary analytic check, not a claim of a new zeta estimate. The inherited quadratic packet is the frozen R17 report, SHA-256 `a7b5290a3d96d2590da42f3fe13a53c1e02499b53d066366824b9f15883a7da3`.
...
The reflected residues visibly retain the local squared zero signal. Fix a distinct nontrivial zero \(\rho=1/2+i\gamma\) of multiplicity m, assume RH, take \(X=1\), and choose a fixed \(W\ge\max(3,|\gamma|)\). This ensures \(w_{a=1/2,W}(\gamma)>0\), since its real sinc argument has magnitude at most one half.
